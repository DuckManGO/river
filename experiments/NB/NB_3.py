...
class Model:
    def __init__(self, detector, metric):
        ...
        self._metric = metric
        self.metric = copy.copy(self._metric)
        self.errors = []
        self.drifts = []
        self.retrain_set = []
        self.k = 48 * 7
        ...
        if self.detector:
            ...
            if self.detector.drift_detected:
                ...
                for _x, _y in self.retrain_set:
                    ...
                    self.metric.update(_y, (self.model.predict_one(_x) or 0.))
...
NB = Model(None, metrics.Accuracy())    
NBAdwin = Model(drift.ADWIN(), metrics.Accuracy())
NBAtwin = Model(drift.atwin.ATWIN(delta=0.0005, temp=1/1000), metrics.Accuracy())
